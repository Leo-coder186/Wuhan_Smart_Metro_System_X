 ...
 * @LastEditTime: 2024-06-28 11:24:55
 */
...
class SimpleLabel {
  ...
  async addLabel() {
    ...
    // vmInstance就是一个vue的实例，传入vue的模板，以及props
  ...
  postRender() {
    ...
    // 1.通过修改定位元素的方式，修改popup的位置
    // 2.通过transform的方式，修改popup的位置
    ...
    // 通过计算近截面大小与远截面大小，计算transform scale的比例
